                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-dashbord" >
                        <a href="index.php" class="non-style-link-menu">
                            <div><p class="menu-text"><i class="fa fa-gauge-high"></i>Dashboard</p></a></div></a>
                    </td>
                </tr>
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-doctor ">
                        <a href="doctors.php" class="non-style-link-menu ">
                            <div><p class="menu-text"><i class="fa fa-user-doctor"></i>Doctors</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-schedule ">
                        <a href="schedule.php" class="non-style-link-menu">
                            <div><p class="menu-text"><i class="fa fa-calendar-days"></i>Schedule</p></div></a>
                    </td>
                </tr>
<!--  Author Name: MayuriK. 
                    ...
                    <td class="menu-btn menu-icon-appoinment menu-active menu-icon-appoinment-active">
                        <a href="appointment.php" class="non-style-link-menu non-style-link-menu-active">
                            <div><p class="menu-text"> 
                                <i class="fa fa-calendar-check"></i>Cita</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-patient">
                        <a href="patient.php" class="non-style-link-menu">
                            <div><p class="menu-text"><i class="material-symbols-outlined">face</i>Pacientes</p></a></div>
                    </td>
                </tr>
               ...
               <!--  <tr >
                ...
                <tr>
                    <td colspan="4" style="width: 100%;" >
                        ...
                        <p class="heading-main12" style="margin-left: 45px;font-size:18px;background: #dae1f3;margin:0px;padding: 12px;color: #444;">Gestion de CITAS (<?php echo $list110->num_rows; ?>)</p>
                    </td>
                            ...
                            <?php
                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                    ...
                                    echo '<tr >
                                       ...
                                       &nbsp;&nbsp;&nbsp;
 &nbsp;&nbsp;&nbsp;
                                       <a href="?action=drop&id='.$appoid.'&name='.$pname.'&session='.$title.'&apponum='.$apponum.'" class="non-style-link badge badge-solid-red">Remove</button></a>
                                       &nbsp;&nbsp;&nbsp;</div>
                                        </td>
                                    </tr>';
