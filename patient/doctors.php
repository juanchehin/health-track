                            ...
                            <?php
                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                    ...
                                    echo '<tr>
                                        ...
                                        <a href="?action=view&id='.$docid.'" class="non-style-link badge badge-solid-green">View</a>
                                       &nbsp;&nbsp;&nbsp;

                                       <a href="?action=session&id='.$docid.'&name='.$name.'"  class="non-style-link badge badge-solid-purple">Sessions</a>
                                        </div>
                                        </td>
                                    </tr>';
